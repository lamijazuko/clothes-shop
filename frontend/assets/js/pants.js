document.addEventListener("DOMContentLoaded", function () {
    // Load all pants products when the page loads
    loadPants();
});

// Helper function to load pants and display them in the category section
function loadPants() {
    const products = JSON.parse(localStorage.getItem("products")) || [];
    const pantsSection = document.getElementById("pants-list");
    pantsSection.innerHTML = ""; // Clear the section before reloading
    ...
    pants.forEach(product => {
        ...
        // Example sizes for pants(adjust according to your products)
